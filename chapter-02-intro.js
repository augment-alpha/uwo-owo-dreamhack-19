...
let story_url = "./chapter2intro.json";
var uwu_love = 0;
var owo_love = 0;
...
const getImageChoice = function(detail, constraint) {
  ...
  switch(detail.metadata.key) {
    ...
    case 'pewdiepie':
        ...
        break;
    case 'uwu':
        console.log('uwu selected');
        displayChoice("You've selected Uwu!");
        setTimeout( function() {
            window.location.replace('./chapter-02-uwu.html');
        }, 1000);
        break;
    case 'owo':
        console.log('owo selected');
        displayChoice("You've selected Owo!");
        setTimeout( function() {
            window.location.replace('./chapter-02-owo.html');
        }, 1000);
        break;
    default: 
